...
df.to_csv("student_data_UNLABELLED.csv", index=False, encoding='utf-8')

print("\nDataFrame limpio:")
print(df.head())
print(df.info())

# MODIFY THIS TO TAKE INTO ACCOUNT MARKS INSTEAD OF TAXA EXIT!XA EXIT!
"""
